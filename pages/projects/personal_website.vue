<template>
  <Project
    :image="personal_website.image.file_name"
    :altText="personal_website.image.alt_text"
    :title="personal_website.name"
    :skills="personal_website.skills"
  >
...
const personal_website = projects.personal_website;
</script>
