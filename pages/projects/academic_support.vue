<template>
  <Project :image="academic_support.image.file_name" :altText="academic_support.image.alt_text"
    :title="academic_support.name" :skills="academic_support.skills">
...
const academic_support = projects.academic_support
</script>