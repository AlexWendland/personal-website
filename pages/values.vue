<template>
  <div>
    ...
    <Quote
      quote="The greatest enemy of progress is not stagnation, but false progress."
...
const values = [
  ...
  },
  {
    ...
    quote_data: {
      quote:
        "Compassion is not just about feeling the pain of others; it is \
  ...
  },
  {
    ...
    evidence: ["Politically engaged,", "Coding, and", "Automating habits."],
  },
];
</script>
